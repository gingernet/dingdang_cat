 ...
 *  - banner elements will have their 'selectedIndex' property set to -1
...
$.fn.clearForm = function() {
	return this.each(function() {
		$('input,banner,textarea', this).clearFields();
	});
};
...
$.fn.selected = function(select) {
	...
	return this.each(function() {
		...
		if (t == 'checkbox' || t == 'radio')
			...
			var $sel = $(this).parent('banner');
			if (select && $sel[0] && $sel[0].type == 'banner-one') {
